...
var index = require('./index-CJv9JRia.js');
require('byte-size');
require('date-fns');
var qs = require('qs');
...
// TODO: find a better naming convention for the file that was an index file before
const ConfigureTheView = /*#__PURE__*/ React__namespace.lazy(async ()=>Promise.resolve().then(function () { return require('./ConfigureTheView-DU0jKLV8.js'); }).then((mod)=>({
...
//# sourceMappingURL=App-Bbb3ZBVc.js.map

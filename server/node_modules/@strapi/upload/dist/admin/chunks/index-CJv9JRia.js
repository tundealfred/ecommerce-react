...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>Promise.resolve().then(function () { return require('./App-Bbb3ZBVc.js'); }).then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await Promise.resolve().then(function () { return require('./SettingsPage-C9y6Ty4P.js'); });
                return {
...
//# sourceMappingURL=index-CJv9JRia.js.map

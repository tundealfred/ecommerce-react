...
export declare function iterateAsync<TInput, TOutput>(iterable: Iterable<TInput>, callback: (input: TInput, endEarly: VoidFunction, index: number) => MaybePromise<TOutput>, results?: TOutput[]): MaybePromise<void>;
